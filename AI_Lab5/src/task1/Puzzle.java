...
public class Puzzle {
	...
	public int computeH2(Node currentState) {
		...
		for (int i = 0; i < MAX_ROW * MAX_COL; i++) {
			int[] locationCurrent = currentState.getLocation(i);
			int[] locationGoal = goalState.getLocation(i);
			result += PuzzleUtils.manhattanDistance(locationCurrent, locationGoal);
		}
		return result;
	}
